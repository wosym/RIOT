 ...
 *
 * The actual address of the device depends on the states of the slave adress pins.
 * @{
 */
...
/**
 * @brief   Read the temperature measerd by the device [CELSIUS].
 *
 * The result value is the measured temperature in CELSUIS and ranges
 * from -30 to 95. 
 *
 * @param[in] dev       device descriptor of the targeted device
 * @param[out] temp     temperature output
 *
 * @return  BH1900NUX_OK on succes
